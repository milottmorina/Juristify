                ...
                <div class="overflow-x-auto relative shadow-md sm:rounded-lg mt-5 bg-white">
                    ...
                    <div class="lg:flex lg:justify-start sm:block">
                        ...
                        <div class="ml-2 ">
                            ...
                            <button type="submit" class="focus:outline-none text-white bg-[#374151] hover:bg-[#374151] focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:focus:ring-green-900">Verified Users</button>
                            </form>
                    </div>
                        <div class="ml-2">
                            <form action="{{ route('user.nonverified') }}" method="GET" role="search" >
                            <button type="submit" class="focus:outline-none text-white bg-[#374151] hover:bg-[#374151] focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:focus:ring-green-900">Not Verified Users</button>
                            </form>
                        </div>
                            <div class="ml-2">
                                <form action="{{ route('user.admin') }}" method="GET" role="search" >
                                <button type="submit" class="focus:outline-none text-white bg-[#374151] hover:bg-[#374151] focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:focus:ring-green-900">Admin Users</button>
                                </form>
                            </div>
                                <div class="ml-2">
                                    <form action="{{ route('user.default') }}" method="GET" role="search" >
                
                                    <button type="submit" class="focus:outline-none text-white bg-[#374151] hover:bg-[#374151] focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:focus:ring-green-900">Default Users</button>
                                    </form>
                                </div>
                      </div>
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            ...
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                               ...
                               <td>
                                <button class="block text-white bg-[#374151] hover:bg-[#374151] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button" data-modal-toggle="defaultModal{{$u->id}}">
                                    VIEW DETAILS
                                   </button> 
                               </td>
                            </tr>
                                    ...
                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                        ...
                                        <div class="p-6 text-center">
                                          <form action="{{route('user.makeadmin',$u->id)}}" method="post">
                                            ...
                                            <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are you sure you want to give admin privileges?</h3>
                                ...
                                <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
                                    ...
                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                        ...
                                        <div class="flex justify-between items-start p-4 rounded-t border-b dark:border-gray-600">
                                            ...
                                            <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="defaultModal{{$u->id}}">
                                                <svg aria-hidden="true" class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                                                <span class="sr-only">Close modal</span>
                                            </button>
                                        </div>
                                        ...
                                        <div class="p-6 space-y-6">
                                            <div class="flex flex-col items-center ">
                                                ...
                                                @endif
                                                <h5 class="mb-1 text-xl font-medium text-gray-900 dark:text-white capitalize">{{$u->name . " ".$u->surname}}</h5>
                                                <div class="flex">
                                                    <span>Email:</span><span class="text-sm text-gray-500 dark:text-gray-400 uppercase font-bold mt-0.5 ml-1">
                                                        {{$u->email}}
                                                    </span></div>
                                                    <div class="flex">
                                                        <span>Phone No:</span><span class="text-sm text-gray-500 dark:text-gray-400 uppercase font-bold mt-0.5 ml-1">
                                                            {{$u->phoneNo}}
                                                        </span></div>
                                                <div class="flex">
                                                <span>Role:</span><span class="text-sm text-gray-500 dark:text-gray-400 uppercase font-bold mt-0.5 ml-1">
                                                    @if($u->role!=1)
                                                    <p class="bg-red-700 text-white rounded p-1 text-center">USER</p>
                                                    @else
                                                    <p class="bg-green-700 text-white rounded p-1 text-center">ADMIN</p>
                                                ...
                                                <div class="flex">
                                                    <span>Verified:</span><span class="text-sm text-gray-500 dark:text-gray-400 uppercase font-bold mt-0.5 ml-1">     @if($u->verified!=1)
                                                        <svg class="w-5 h-5 text-red-500 text-center" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                                                        @else
                                                        <svg class="w-5 h-5 text-green-500 text-center" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path></svg>
                                                        @endif</span></div>
                                                        ...
                                                        <img src="/storage/id_card/{{$linkId[2]}}" width="150px" alt="" alt="id">
                                                ...
                                                <div class="flex space-x-3 md:mt-6">
                                                    <a href="#" class="inline-flex items-center py-2 px-4 text-sm font-medium text-center text-white rounded-lg">
                                                        @if ($u->verified!=1)
                                                        <a  data-modal-toggle="popup-modal{{$u->id}}" class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">VERIFY</a>
                                                        @else
                                                        <a data-modal-toggle="popup-modali{{$u->id}}" class="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-xs px-5 py-2.5 mr-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800">UN-VERIFY</a>
                                                        @endif
                                                    </a>
                                                    <a href="#" class="inline-flex items-center py-2 px-4 text-sm font-medium text-center text-white rounded-lg">
                                                        @if($u->role!=1)
                                                        <a data-modal-toggle="popup-modalAdmin{{$u->id}}" class="focus:outline-none text-white bg-indigo-700 hover:bg-indigo-800 focus:ring-4 focus:ring-indigo-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-indigo-600 dark:hover:bg-indigo-700 dark:focus:ring-indigo-800">MAKE ADMIN</a>
                                                        @else
                                                        <a data-modal-toggle="popup-modaliUser{{$u->id}}" class="focus:outline-none text-white bg-yellow-700 hover:bg-yellow-800 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-yellow-600 dark:hover:bg-yellow-700 dark:focus:ring-yellow-800">MAKE USER</a>
                                                        @endif  
                                                    </a>
                                        ...
                                        <div class="flex items-center p-6 space-x-2 rounded-b border-t border-gray-200 dark:border-gray-600">
                                            <button data-modal-toggle="defaultModal{{$u->id}}" type="button" class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600">Back</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <div class="p-6 text-center">
                              <form action="{{route('user.cverifiko',$u->id)}}" method="post">
                                  @csrf
                                <svg aria-hidden="true" class="mx-auto mb-4 w-14 h-14 text-gray-400 dark:text-gray-200" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                                <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are you sure you want to unverify this user?</h3>
