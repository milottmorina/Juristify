@include('layouts.app')
    ...
    <div class="relative flex justify-center">
      ...
      <p class="absolute top-50 text-2xl text-white text-center">My Profile</p>
    </div>
  </div>
...
<main class="relative -mt-32">
        ...
        <div class="divide-y divide-gray-200 lg:grid lg:grid-cols-12 lg:divide-y-0 lg:divide-x">
          <aside class="py-6 lg:col-span-3">
            <nav class="space-y-1">
              ...
              <a href="{{route('user.index')}}" class="bg-teal-50 border-teal-500 text-teal-700 hover:bg-teal-50 hover:text-teal-700 group border-l-4 px-3 py-2 flex items-center text-sm font-medium" aria-current="page">
                <!--
  ...
  <a href="{{route('user.password')}}" class="border-transparent text-gray-900 hover:bg-gray-50 hover:text-gray-900 group border-l-4 px-3 py-2 flex items-center text-sm font-medium">
